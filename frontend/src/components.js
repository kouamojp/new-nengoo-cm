          ...
          <div className="lg:col-span-4">
            ...
            {activeSection === 'user_access' && (
              <div>
                ...
                <p className="text-gray-600 mb-6">Le Super Administrateur peut voir et modifier tous les profils utilisateurs.</p>
                          ...
                          <tr key={buyer.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex space-x-2">
                                ...
                                <button
                                  onClick={() => {
                                    alert(`Profil de ${buyer.name}\n\n- Commandes: ${buyer.orders}\n- Dépensé: ${formatPrice(buyer.spent)}\n- Membre depuis: ${buyer.joinDate}\n\nFonctionnalité: Vue détaillée du profil avec historique complet.`);
                                  }}
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">WhatsApp (non modifiable)</label>
                          <input
                            type="text"
                        ...
                        <div>
                          ...
                          <select defaultValue={editingUser.status} className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg p-6">
                    ...
                    <p className="text-sm opacity-90 mb-4">Modifier les produits</p>
                  ...
                  <div className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg p-6">
                    ...
                    <p className="text-sm opacity-90 mb-4">Gérer catégories</p>
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg p-6">
                    ...
                    <p className="text-sm opacity-90 mb-4">Contenu pages</p>
