...
// Pickup Points Map Component - Affichage par ville
...
// Mock data pour les points de retrait
...
// Mock data pour les gestionnaires de points de retrait
const mockPickupManagers = [
  {
    id: 'manager_001',
    name: 'Jean Mbarga',
